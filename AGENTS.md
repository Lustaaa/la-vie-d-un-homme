...
3. Gere la correspondance prenom → abréviation :
   a. Si le front matter contient déjà un champ `correspondance` (dictionnaire YAML `Prenom: Ab`), utilise cette table telle quelle pour l'anonymisation du corps du texte.
